...
## Task #22 - CustomPromise: thenable и static

Это испытание является продолжением предыдущего и является последним шагом в реализации "облегчённой" версии объекта промиса.
