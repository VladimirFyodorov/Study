...
type ConstructTuple<L extends number, Res extends unknown[] = []> =
  L extends Res['length'] ? Res : ConstructTuple<L, [...Res, unknown]>

type NumberRange<
  L extends number,
  H extends number,
  Arr extends any[] = ConstructTuple<L>,
  Res = L> = 
  H extends Arr['length'] ? Res | Arr['length']
  : NumberRange<L, H, [...Arr, unknown], Res | Arr['length']>

type T = NumberRange<0, 2>
