...
type ArrayFromString<S extends string> = S extends `${infer First}${infer Rest}` ? [First, ...ArrayFromString<Rest>] : []
type LengthOfString<S extends string> = ArrayFromString<S>['length']
