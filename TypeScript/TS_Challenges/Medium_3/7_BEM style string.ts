...
type BEM<B extends string, E extends string[], M extends string[]> = 
  [IsEmpty<E>, IsEmpty<M>] extends [true, true]   ? B :
  [IsEmpty<E>, IsEmpty<M>] extends [false, true]  ? `${B}__${E[number]}` :
  [IsEmpty<E>, IsEmpty<M>] extends [true, false]  ? `${B}--${M[number]}` :
  [IsEmpty<E>, IsEmpty<M>] extends [false, false] ? `${B}__${E[number]}--${M[number]}` : never
